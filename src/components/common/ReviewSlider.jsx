    ...
    return(
        <div className="text-white">
            <div className="my-[50px] h-[184px] max-w-maxContentTab lg:max-w-maxContent">
                <Swiper slidesPerView={4} spaceBetween={25} loop={false} className="w-full"
                    freeMode={true} autoplay={{delay: 2500, disableOnInteraction: false}}
                                ...
                                <SwiperSlide key={i}>
                                    <div className="flex flex-col gap-3 bg-richblack-800 p-3 text-[14px] text-richblack-25">
                                        ...
                                        <div className="flex items-center gap-2 ">
                                            ...
                                            <ReactStars count={5} value={review.rating} size={20}
                                                edit={false} activeColor="#ffd700" emptyIcon={<FaStar/>} filledIcon={<FaStar/>}
                                            />
                                        </div>
                                    </div>
                                </SwiperSlide>
