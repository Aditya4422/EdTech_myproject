...
const tabsName = [ "Free", "New to coding", "Most popular", "Skills paths", "Carrer paths" ];
...
const ExploreMore = () => {
  ...
  return (
    <div>
        ...
        <div className='absolute flex flex-row gap-10 justify-between w-full bg-richblack-200'>
          {
