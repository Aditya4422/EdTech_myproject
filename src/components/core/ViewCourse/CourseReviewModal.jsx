        ...
        <div className=' p-6'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='mt-6 flex flex-col items-center'>
            ...
            <div className='flex w-11/12 flex-col space-y-2'>
              ...
              <textarea name="courseExperience" id="courseExperience" placeholder='Add Your Experience'
                  {...register("courseExperience", {required: true})} className='form-style resize-x-none min-h-[130px] w-full'
              />
              {
