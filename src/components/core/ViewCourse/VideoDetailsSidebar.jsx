    ...
    <div className='flex h-[calc(100vh-3.5rem)] w-[320px] max-w-[350px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800'>
        <div className='mx-5 flex flex-col items-start justify-between gap-2 gap-y-4 border-b border-richblack-600 py-5 text-lg font-bold text-richblack-25'>
            ...
            <div className='flex w-full items-center justify-between'>
              ...
              <IconBtn text={`Add Review`} customClasses="ml-auto"
        ...
        <div className="h-[calc(100vh - 5rem)] overflow-y-auto">
            {
              courseSectionData.map((course, index) => (
                <div key={index} onClick={() => setActiveStatus(course?._id)} className="mt-2 cursor-pointer text-sm text-richblack-5">
                        ...
                        <div className=' transition-[height] duration-500 ease-in-out'>
                          {
                            course.subSection.map((topic, i) => (
                             ...
                             key={i} className={`${videoBarActive === topic._id ? "bg-yellow-200 font-semibold text-richblack-800" : "hover:bg-richblack-900"} flex gap-3  px-5 py-2`}
                            >
