...
const VideoDetails = () => {
  ...
  const goToNextVideo = () => {
    ...
    if(currentSectionIndx !== noOfSubSections - 1){
    ...
    <div className='flex flex-col gap-5 text-white'>
      {
        ...
        : (<Player ref={playerRef} playsInline aspectRatio='16:9'
                  ...
                  >
                    {
                      !completedLectures.includes(subSectionId) && (
                        <IconBtn disabled={loading} customClasses={`text-xl max-w-max px-4 mx-auto`}
                          onclick={() => handleLectureCompletion()} text={!loading ? "Mark As Completed" : "Loading..."}
                        />
                      )
                    }
