...
import { changePassword } from '../../../../services/operations/SetttingsAPI';
...
const UpdatePassword = () => {
  ...
  const submitPasswordForm = async (data) => {
    try{
      ...
      console.log("Can't submit and update the password ", error.message);
    }
  }
          ...
          <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
              ...
              <div className="flex flex-col gap-5 lg:flex-row">
                  <div className="relative flex flex-col gap-2 lg:w-[48%]">
                      ...
                      <input type={showOldPassword ? "text" : "password"} name='oldPassword' id='oldPassword' placeholder='Enter Current Password'
                             {...register("oldPassword", {required: true})} className='form-style'
                      />
                  ...
                  <div className="relative flex flex-col gap-2 lg:w-[48%]">
                      ...
                      <input type={showNewPassword ? "text" : "password"} name='newPassword' id='newPassword' placeholder='Enter New Password'
                             {...register("newPassword", {required: true})} className='form-style'
                      />
