...
import { updateDisplayPicture } from '../../../../services/operations/SetttingsAPI';
...
const ChangeProfilePicture = () => {
    ...
    const [previewSource, setPreveiwSource] = useState(null);
    ...
    const handleFileChange = (e) => {
        ...
        console.log("file we get for updating picture is :", file);
        if(file){
            setImageFile(file);
            previewFile(file);
        }
    ...
    const previewFile = (file) => {
        ...
        reader.onloadend = () => {
            setPreveiwSource(reader.result)
        }
    }
    ...
    const handleFileUpload = () => {
        try{
            ...
            console.log("form data for upating the picture is ", formData);
